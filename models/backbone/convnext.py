...
class ConvNeXtSmall(ConvNeXt):
    ...
    def __init__(self):
        super().__init__(depths=[3, 3, 27, 3], dims=[96, 192, 384, 768])


class ConvNeXtBase(ConvNeXt):

    def __init__(self):
        super().__init__(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024])


class ConvNeXtLarge(ConvNeXt):

    def __init__(self):
        super().__init__(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536])

class ConvNeXtXLarge(ConvNeXt):

    def __init__(self):
        super().__init__(depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048])
